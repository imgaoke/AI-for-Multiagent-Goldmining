...
public class LocalWorldModel extends WorldModel {
    ...
    public Location bestOne(ArrayList<Location> l){
        ...
        for (Location loc : l){
            ...
            if (loc.x - 1 >= 0) visitsCount += visitsCount + visited[loc.x - 1][loc.y]; neighboursCount++;
            if (loc.x + 1 < getWidth()) visitsCount += visitsCount + visited[loc.x + 1][loc.y]; neighboursCount++;
            if (loc.y - 1 >= 0) visitsCount += visitsCount + visited[loc.x][loc.y - 1]; neighboursCount++;
            if (loc.y + 1 < getHeight()) visitsCount += visitsCount + visited[loc.x][loc.y + 1]; neighboursCount++;
